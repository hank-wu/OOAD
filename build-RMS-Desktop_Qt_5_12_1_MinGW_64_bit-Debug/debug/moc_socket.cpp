...
QT_MOC_LITERAL(4, 31, 15), // "socketConnected"
QT_MOC_LITERAL(5, 47, 18), // "socketDisconnected"
QT_MOC_LITERAL(6, 66, 11), // "connectFail"
QT_MOC_LITERAL(7, 78, 15), // "onNewConnection"
QT_MOC_LITERAL(8, 94, 11), // "onConnected"
QT_MOC_LITERAL(9, 106, 14), // "onDisconnected"
QT_MOC_LITERAL(10, 121, 9), // "onReceive"
QT_MOC_LITERAL(11, 131, 7), // "onError"
QT_MOC_LITERAL(12, 139, 28) // "QAbstractSocket::SocketError"

    },
    "Socket\0received\0\0newConnection\0"
    "socketConnected\0socketDisconnected\0"
    "connectFail\0onNewConnection\0onConnected\0"
    "onDisconnected\0onReceive\0onError\0"
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::newConnection)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Socket::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::socketConnected)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Socket::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::socketDisconnected)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Socket::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::connectFail)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 0
void Socket::received(QString _t1)
{
